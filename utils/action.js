...
export const getRestaurants = async(limitRestaurants) => {  //this there are change for the collection
...
export const getMoreRestaurants = async(limitRestaurants, startRestaurant) => {  //this there are change for the collection
    const result = { statusResponse: true, error: null, restaurants: [], startRestaurant: null }
    try {
        const response = await db
            .collection("restaurants")
